---
name: gungu-red-panda-illustrations
description: 生成滚滚小熊猫 IP 的中文正文配图。用于用户要求为中文文章、帖子、博客、Notion 文档、工作流文档、方法论、流程、结构、状态、隐喻或观点生成“滚滚”“小熊猫”“red panda”“手绘”“正文配图”“文章插图”“配图建议”“shot list”“去标题/改图”等任务；默认使用滚滚 IP、纯白手绘、彩色少量中文批注、简洁清爽但天马行空的视觉风格。
---
...
默认视觉 IP 是「滚滚」：一只小熊猫 / red panda，也是 AI 时代的互联网产品经理。滚滚必须参与画面的核心动作，不能只是站在旁边当装饰。
...
- `references/gungu-ip.md`：滚滚 IP 的形象、性格、动作库、本机资产和禁忌。
...
- 大量留白
- 滚滚小熊猫作为核心动作主体
- 滚滚固定识别点：橙红毛发、白色脸部花纹、深棕脸颊、环纹尾巴、黑色耳机或深色 hoodie
- 少量彩色中文手写批注
